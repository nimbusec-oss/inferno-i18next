(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('inferno-component'), require('inferno-shared'), require('inferno-create-element'), require('inferno'), require('inferno-vnode-flags'), require('html-parse-stringify2')) :
	typeof define === 'function' && define.amd ? define('inferno-i18next', ['exports', 'inferno-component', 'inferno-shared', 'inferno-create-element', 'inferno', 'inferno-vnode-flags', 'html-parse-stringify2'], factory) :
	(factory((global.infernoI18Next = {}),global.Component,global.infernoShared,global.createElement,global.Inferno,global.VNodeFlags,global.HTML));
}(this, (function (exports,Component,infernoShared,createElement,Inferno,VNodeFlags,HTML) { 'use strict';
...
Inferno = Inferno && Inferno.hasOwnProperty('default') ? Inferno['default'] : Inferno;
VNodeFlags = VNodeFlags && VNodeFlags.hasOwnProperty('default') ? VNodeFlags['default'] : VNodeFlags;
...
function renderNodes(children, targetString, i18n) {
    ...
    return astNodes.reduce(function (mem, node, i) {
      if (node.type === 'tag') {
        ...
        if (typeof child === 'string') {
          ...
          mem.push(Inferno.cloneVNode(child, _extends({}, child.props, { key: i }), inner));
  ...
  var result = mapAST([{ dummy: true, children: children, flags: 4 }], ast);
...
var T = function (_Component) {
  ...
  createClass(T, [{
    ...
    value: function render() {
      ...
      return createElement(useAsParent, additionalProps, renderNodes(children, translation, i18next));
    }
  }]);
  return T;
}(Component);
